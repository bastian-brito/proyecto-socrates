...
from Modelo.Modelos import Rol_Aplicacion
...
# @roles_aplicacion_bp.route("/nuevo_rol_aplicacion", methods = ['GET'])
# def nuevo_rol_aplicacion():
#     roles_aplicacion = Rol_Aplicacion.query.order_by(Rol_Aplicacion.fecha_creacion.asc()).all()  
#     return render_template("usuarios/nuevo_rol_aplicacion.html", roles_aplicacion=roles_aplicacion)
...
@roles_aplicacion_bp.route('/lista_roles', methods = ['POST'])    
def crear_rol():
